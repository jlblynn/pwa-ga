...
(function() {
  ...
  // use the gtag.js API to send specific events to our property, which can be organized with categories and labels
  const favorite = () => {
    // a custom event with the action "favorite" is fired
    gtag('event', 'favorite', {
      // event is organized with the "photos" category and "cats" label
